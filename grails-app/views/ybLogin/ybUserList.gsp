...
<div class="yzf_01">
    <div class="yzf_01_top">
        ...
        <g:link action="ybUserCreate" target="_self"><span class="yzf_05_01_ts">删除</span></g:link><a href="javascrip:;" target="_self" id="ybUserCreate"><span class="yzf_05_01_ts">添加</span></a>
    </div>
    <div class="yzf_07_bot">
        ...
        <g:each in="${ybUserInstanceList}" status="i" var="userInstance">
            <a class="ybUserEdit" href="javascript:;"><span>${userInstance?.id}</span><span>${userInstance?.username}</span><span>${userInstance?.name}</span><span>${userInstance?.position}</span><span>${userInstance?.phone}</span></a>
