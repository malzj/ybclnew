                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <g:link controller="fwsClientLogin" action="fwsUserCreate" class="btn btn-info" style="display:block;float:right;" id="${params.id}">新建用户</g:link>
                        ...
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <g:each in="${fwsUserList}" status="i" var="userInstance">
                                <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                    ...
                                    <td>${userInstance.department.name}</td>
                                    <td>${userInstance.money}</td>
                                    <td>${userInstance.time}</td>



                                    <td>
                                        <g:link action="fwsUserShow" id="${userInstance?.id}" class="btn btn-success btn-xs"><i class="fa fa-eye"></i></g:link>
                                        <g:link action="fwsUserEdit" id="${userInstance?.id}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></g:link>
