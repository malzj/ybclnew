            ...
            <div class="middle_content">
                <div class="m_box">
                    <header class="panel-heading">
                        <span><i class="yh"></i>工位信息</span>
                    </header>
                    <table>
                        <tr>
                            <td>工位名称：</td>
                            <td width="345">${fieldValue(bean: fwsStationInstance, field: "stationName")}</td>
                        </tr>
                        <tr>
                            <td>工位个数：</td>
                        ...
                        <tr>
                            <td>服务商店Id：</td>
                            <td>${fieldValue(bean: fwsStationInstance, field: "fwsShopId")}</td>
                        </tr>
                        <tr>
                            <td></td>
                            <td align="right">
